...
//summary
  ...
  const sections = {
                ...
                data={{
                  ...
                  datasets: [{
                    ...
                    segment: {
                      ...
                      backgroundColor: ctx => {
                        const a = ctx?.p0?.parsed?.y; const b = ctx?.p1?.parsed?.y; const base = b >= a ? 'rgba(61, 255, 13, 0.18)' : 'rgba(236, 8, 8, 0.14)';
                        return base;
                      }
                    },
                  }]
      ...
      <div id="overview-progress-chart" className="bg-white/10 backdrop-blur-md rounded-lg shadow-lg p-6 border border-white/20 text-white">
        ...
        {filterModal.open && filterModal.section && (
          <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-800 backdrop-blur-md border border-white/30 rounded-lg shadow-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto text-white">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold">
                  {filterModal.section === 'trend' && 'Trend Filters'}
                  {filterModal.section === 'companyPerformance' && 'Company Performance Filters'}
                  {filterModal.section === 'companyProgress' && 'Company Progress Filters'}
                </h3>
              </div>
              {filterModal.section === 'trend' && (
              ...
              {filterModal.section === 'companyPerformance' && (
                <div className="space-y-4">
                  <div>
              ...
              {filterModal.section === 'companyProgress' && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm mb-1">Mode</label>
                    <select
    ...
    kras: (
      <div id="kras-section" className="bg-white/10 backdrop-blur-md rounded-lg shadow-lg p-6 border border-white/20 text-white mb-8">
        ...
        {kraDept && (() => {
          ...
          return (
            <div className="overflow-x-auto bg-black/20 rounded-lg shadow-inner">
              <table id="kra-table" className="w-full min-w-[700px]">
                <thead>
                  <tr className="border-b border-white/20 bg-white/20">
                    <th className="text-left p-3 text-white font-semibold">KRA Name</th>
        ...
        {kraModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-800 backdrop-blur-md border border-white/30 rounded-lg shadow-7xl p-6 max-w-[800px] w-full max-h-auto overflow-y-auto text-white">
              ...
              {kraModalState.loading ? (
                ...
                <div className="space-y-4">
                  {kraModalState.aggregate && (
                    <div className="bg-white/5 text-white border border-black/20 rounded p-3">
                      <div className="text-sm ">Aggregate Score</div>
                      <div className="text-2xl font-semibold ">{kraModalState.aggregate.percentage ?? 0}% <span className="text-sm text-gray-400">({kraModalState.aggregate.count || 0} KPIs)</span></div>
                    </div>
                  )}
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {(kraModalState.kpis || []).map(k => (
                          <tr key={k.id} className="border-b border-black/20">
    ...
    review: (
      <div className="bg-white/10 backdrop-blur-md rounded-lg shadow-lg p-6 border border-white/20 text-white mb-8">
        ...
        {revRatingModalOpen && (
          <div className="fixed inset-0 flex items-start justify-center pt-24 z-[9999]">
            <div className="bg-gray-800 backdrop-blur-lg border border-white/20 text-white w-full max-w-sm rounded shadow-lg p-6">
              <div className="flex justify-between items-center mb-4">
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto py-8 px-4"> {/* Added padding for spacing */}
        {/* Navigation Tabs */}
